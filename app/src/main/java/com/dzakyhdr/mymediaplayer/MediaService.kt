...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.dzakyhdr.mymediaplayer.mysound.MediaService.create"
        const val ACTION_DESTROY = "com.dzakyhdr.mymediaplayer.mysound.MediaService.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
    ...
    internal class IncomingHandler(playerCallback: MediaPlayerCallback) :
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                ...
                STOP -> mediaPlayerCallbackWeakReference.get()?.onPause()
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.skinnyfabs_happy)
        try {
